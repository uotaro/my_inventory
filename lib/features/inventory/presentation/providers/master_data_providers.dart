...
Stream<List<InventoryType>> inventoryTypeList(Ref ref) {
  return ref.watch(inventoryTypeRepositoryProvider).watchInventoryTypes();
}

@Riverpod(keepAlive: true)
Stream<List<Category>> categoryList(Ref ref, {int? inventoryTypeId}) {
  return ref
      .watch(categoryRepositoryProvider)
      .watchCategories(inventoryTypeId: inventoryTypeId);
}
